...
function default_page(){
	...
	SmartyValidate::register_form('note_form',true);
	...
	$LGCLASS->page_tpl='admin/add_note.tpl'; // This current's page template file.
...
if(!empty($_POST)){
	if(SmartyValidate::is_valid($_POST,'note_form')){
		SmartyValidate::disconnect();
		$CONTACT->updateContact('note',$_POST);
	}else{
