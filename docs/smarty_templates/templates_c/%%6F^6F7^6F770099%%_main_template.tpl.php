<?php /* Smarty version 2.6.11, created on 2018-03-22 00:39:48
         compiled from _main_template.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', '_main_template.tpl', 24, false),)), $this); ?>
<?php if ($this->_tpl_vars['header']):  $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => ($this->_tpl_vars['header']), 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
  endif; ?>
<body id="<?php echo $this->_tpl_vars['content_array']['config']['name'];  echo $this->_tpl_vars['cfoo']; ?>
">
...
unset($_smarty_tpl_vars);
 ?>
		...
		<div id="subnav">		
			<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "_subnav.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
		</div>
...
unset($_smarty_tpl_vars);
		...
		<?php endif; ?>
		<BR>
<?php if ($_SESSION['msg']):  echo $_SESSION['msg'];  endif; ?> 						
	</div>
