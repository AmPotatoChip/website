...
<a href="view_article.php?article_id=!{$smarty.get.article_id}&full=yes&pbr=!{$previous}"><<</a> 
...
<a href="view_article.php?article_id=!{$smarty.get.article_id}&full=yes&pbr=!{$next}">>></a>
!{/if}
