...
$key_dropper_data = collectKeyDroppers($_GET[days]);
$smarty->assign('keydropper',$key_dropper_data);
...
$LGCLASS->page_tpl='key_dropper.tpl'; // This current's page template file.
